...
namespace TriviaSpark.Core.Services
{
    ...
    {
        private List<string> GetQuestionsWithoutCorrectResponse(List<Services.QuestionProvider.QuestionAnswerSet> questions, List<Services.QuestionProvider.QuestionAnswerSet> answered)
        {
        ...
        {
            List<Services.QuestionProvider.QuestionAnswerSet> unasweredQuestions = [];
            ...
            foreach (var questionId in correctAnswersByQuestion.Keys)
            {
                ...
                if (!attemptedAnswersByQuestion.ContainsKey(questionId))
                {
                    ...
                    unasweredQuestions.Add(new Services.QuestionProvider.QuestionAnswerSet { QuestionId = questionId, AnswerId = 0 });
                }
        ...
        private static Dictionary<string, HashSet<int>> AttemptedAnswersByQuestion(IEnumerable<Models.MatchQuestionAnswerModel> matchQuestionAnswers)
        {
            ...
            return matchQuestionAnswers
                .Select(a => new Services.QuestionProvider.QuestionAnswerSet()
                {
