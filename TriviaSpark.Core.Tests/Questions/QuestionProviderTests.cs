...
namespace TriviaSpark.Core.Tests.Questions
{
    ...
    {
        private MatchModel myMatch = new();
        ...
        public void TestInit()
        {
            myMatch.MatchQuestions.Add(
                new QuestionModel
                {
                    ...
                    {
                        new QuestionAnswerModel {QuestionId="Q1", AnswerId = 1, AnswerText = "Paris", IsCorrect = true },
                        new QuestionAnswerModel {QuestionId="Q1", AnswerId = 2, AnswerText = "London", IsCorrect = false },
                        new QuestionAnswerModel {QuestionId="Q1", AnswerId = 3, AnswerText = "Rome", IsCorrect = false },
                        new QuestionAnswerModel {QuestionId="Q1", AnswerId = 4, AnswerText = "Berlin", IsCorrect = false }
                    }
                });
            myMatch.MatchQuestions.Add(
                new QuestionModel
                {
                    ...
                    Answers = new List<QuestionAnswerModel>
                    {
                        new QuestionAnswerModel {QuestionId="Q2", AnswerId = 5, AnswerText = "London", IsCorrect = true },
                        new QuestionAnswerModel {QuestionId="Q2", AnswerId = 6, AnswerText = "Paris", IsCorrect = false },
                        new QuestionAnswerModel {QuestionId="Q2", AnswerId = 7, AnswerText = "Rome", IsCorrect = false },
                        new QuestionAnswerModel {QuestionId="Q2", AnswerId = 8, AnswerText = "Berlin", IsCorrect = false }
                    }
                });
            myMatch.MatchQuestions.Add(
                new QuestionModel
                {
                    ...
                    Answers = new List<QuestionAnswerModel>
                    {
                        new QuestionAnswerModel {QuestionId="Q3", AnswerId = 9, AnswerText = "Rome", IsCorrect = true },
                        new QuestionAnswerModel {QuestionId="Q3", AnswerId = 10, AnswerText = "London", IsCorrect = false},
                        new QuestionAnswerModel {QuestionId="Q3", AnswerId = 11, AnswerText = "Paris", IsCorrect = false },
                        new QuestionAnswerModel {QuestionId="Q3", AnswerId = 12, AnswerText = "Berlin", IsCorrect = false }
                    }
                });
            myMatch.MatchQuestions.Add(
                new QuestionModel
                {
                    ...
                    Answers = new List<QuestionAnswerModel>
                    {
                        new QuestionAnswerModel {QuestionId="Q4", AnswerId = 13, AnswerText = "Berlin", IsCorrect = true },
                        new QuestionAnswerModel {QuestionId="Q4", AnswerId = 14, AnswerText = "Rome", IsCorrect = false },
                        new QuestionAnswerModel {QuestionId="Q4", AnswerId = 15, AnswerText = "London", IsCorrect = false},
                        new QuestionAnswerModel {QuestionId="Q4", AnswerId = 16, AnswerText = "Paris", IsCorrect = false }
                    }
                });
        ...
        public void CalculateScore_StateUnderTest_ExpectedBehavior()
        {
            ...
            var answers = new List<MatchQuestionAnswerModel>
            {
        ...
        private static MatchQuestionAnswerModel Create(QuestionAnswerModel s, MatchModel matchModel)
        {
            return new MatchQuestionAnswerModel()
            {
